...
// Run the program to see the results in the console. Nicely formatted, right? Notice how each array had a different number of items, but we handled that by taking the length of each array, as pantry[packageType] is the correct way to refer to the value of each property.//console.log(""); // skip a line in console
...
if(pantry[type][index]){
console.log(`\t${pantry[type][index]}`);
}
}
